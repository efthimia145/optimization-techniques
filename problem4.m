...
for i=1:size(l, 2)
    ...
    [minimum(i, 1), k(i, 1), ak1, bk1] = bisection_derivative_method(f1, x, l(i), a, b);
    [minimum(i, 2), k(i, 2), ak2, bk2] = bisection_derivative_method(f2, x, l(i), a, b);
    [minimum(i, 3), k(i, 3), ak3, bk3] = bisection_derivative_method(f3, x, l(i), a, b);
