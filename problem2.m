...
for i=1:size(l, 2)
    [minimum(i, 1), k(i, 1), ak1, bk1] = golden_section_method(f1, l(i), a, b);
    [minimum(i, 2), k(i, 2), ak2, bk2] = golden_section_method(f2, l(i), a, b);
    [minimum(i, 3), k(i, 3), ak3, bk3] = golden_section_method(f3, l(i), a, b);
